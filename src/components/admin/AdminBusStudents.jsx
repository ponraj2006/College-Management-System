...
export default function AdminBusStudents({ students }) {
    ...
    const totalBus = students.filter((s) => s.isBus).length;
    ...
    return (
        <div className="dashboard-page fade-in">
            <div className="page-header">
                <div>
                    <h1>Bus Students 🚌</h1>
                    <p className="subtitle">Students using college transport facility</p>
                </div>
                <div className="header-badge admin-badge">
                    <HiOutlineTruck size={16} style={{ marginRight: 6 }} />
                    <span>{totalBus} bus students</span>
                </div>
            </div>
            ...
            <div className="staff-results-count">
                Showing <strong>{busStudents.length}</strong> bus students
            </div>
                    ...
                    <table className="data-table">
                        ...
                        <tbody>
                            {busStudents.length === 0 ? (
                                <tr><td colSpan="7" className="staff-empty-row">No bus students found.</td></tr>
                            ) : (
                                busStudents.map((s) => (
                                    <tr key={s.id}>
